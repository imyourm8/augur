 ...
 */
contract ExitFillOrder is Initializable, ReentrancyGuard, IExitFillOrder {
    using SafeMathUint256 for uint256;
    ...
    function initialize(IAugur _augur, IAugurTrading _augurTrading, address _zeroXTrade) public beforeInitialized {
        ...
        Trade.StoredContracts memory _storedContracts = Trade.StoredContracts({
            augur: _augur,
            augurTrading: _augurTrading,
        ...
        storedContracts = _storedContracts;
