...
contract ShareToken is ITyped, Initializable, ERC1155, IShareToken, ReentrancyGuard {
    ...
    */
    ...
    function claimTradingProceeds(IMarket _market, address _shareHolder, address _affiliateAddress) external nonReentrant returns (uint256[] memory _outcomeFees) {
        return claimTradingProceedsInternal(_market, _shareHolder, _affiliateAddress, false);
    }
    ...
    function claimTradingProceedsInternal(IMarket _market, address _shareHolder, address _affiliateAddress, bool toOICash) internal returns (uint256[] memory _outcomeFees) {
